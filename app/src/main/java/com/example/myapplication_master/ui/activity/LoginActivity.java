...
import com.example.myapplication_master.utils.ProgressDialogHelper;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private ProgressDialogHelper progressDialogHelperRole;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialogHelperRole = new ProgressDialogHelper(this);
        // 获取输入框
            ...
            public void onResponse(Call<UserApiResponse> call, Response<UserApiResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (apiResponse != null && apiResponse.getCode() == 200) {
                        if("admin".equals(apiResponse.getData().getRole())){
                            ...
                            progressDialogHelperRole.showProgressDialog("登录失败，当前用户权限不足，请换用管理员账号");
                            progressDialogHelperRole.showProgressDialogButton();
